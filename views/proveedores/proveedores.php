            ...
            <div class="modal-body form">
                <form action="" id="form" class="form-horizontal" method="POST">
                    <div class="form-body">
                        ...
                        <input value="" name="id_prov" type="hidden" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <center>
                    ...
                    <button type="button" id="btnSave" onclick="guardar_proveedor()" data-toggle="tooltip" title="Guardar" class="btn btn-ver margin glyphicon glyphicon-floppy-disk"></button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
                                            ...
                                            "ajax": {
                                                "url": "?controller=proveedores&action=all",
                                                "type": "POST"
                                            },
                                        });
                                        });
