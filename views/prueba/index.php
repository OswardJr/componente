...
<section class="content">
  <div class="row" style="margin-left:10%;">
    <iframe src="views/reportes/factura_compra.php?cod_compra=<?php echo $_GET['cod'] ?>" width="90%" frameborder="0" height="500">
      <p>Your browser does not support iframes.</p>
    </iframe>
  </div>
     <div class="row">
            <div class="col-xs-offset-5 col-xs-1">
              <a class="btn btn-ver glyphicon glyphicon-arrow-left"  href="?controller=compras&action=index" title="Volver" type="submit"
               >VOLVER</a>
            </div>
          </div>
</section>
