...

{
   ...
   if (isset($_GET["cod_presu"])){
      ...
      $c->borrar_presupuesto($cod_presu);
...

{
  ...
  foreach ($presupuestos as $presu) {
		        ...
		        $presu['estado'],
		        '
		        <a  data-toggle="tooltip" title="Ver" href="http://localhost/componente/views/reportes/factura_presu.php?cod_presu='.$presu['codigo'].'"><i class=" btn btn-xs btn-ver glyphicon glyphicon-eye-open"></i></a>
                <a  data-toggle="tooltip" title="Desactivar" href="javascript:void(0)" onclick="javascript:borrar_presupuesto('."'".$presu['codigo']."'".')" ><i class=" btn btn-xs btn-delete
        ...
        public function buscarPresupuestoPorCod()
        {
           $cod_presu = $_GET["cod_presu"];
           $c = new presupuesto();
           if (isset($_GET["cod_presu"]) and $_GET["cod_presu"] != "") {
              $presupuesto = $c->get_presupuesto_by_cod($cod_presu);
          }
     ...
     {
         require_once("views/layout/template.php");
         require_once("views/presupuestos/ReporteCliente.php");
     }

      public function listadoclifecha(){
    require_once("views/layout/template.php");
    require_once("views/presupuestos/listadoclipresu.php");
  }
